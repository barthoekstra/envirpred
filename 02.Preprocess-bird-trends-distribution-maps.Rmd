...
We will use species trends derived from [PECBMS](https://pecbms.info/trends-and-indicators/species-trends/), the Pan-European Common Bird Monitoring Scheme, which contains trends for 179 European breeding birds.
...
```{r join_species_distributions_trends, results='hide', warning=FALSE, message=FALSE}
