...
tmmx2 <- rgee_harmonic_regression(dataset = "IDAHO_EPSCOR/TERRACLIMATE", dependent = "tmmx", harmonics = 2,
                                  ...
                                  refdataset = "NASA/GIMMS/3GV0")
def1 <- rgee_harmonic_regression(dataset = "IDAHO_EPSCOR/TERRACLIMATE", dependent = "tmmx", harmonics = 1,
                                 aoi = aoi, resolution = res, dsn = "data/raw/gee/def_1.tif"
                                 refdataset = "NASA/GIMMS/3GV0")
def2 <- rgee_harmonic_regression(dataset = "IDAHO_EPSCOR/TERRACLIMATE", dependent = "tmmx", harmonics = 2,
