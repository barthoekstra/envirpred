...
bandnames <- c("ndvi", "ndvi_resid", "ndvi_trend", "pr", "pr_resid", "pr_trend", "aet", "aet_resid", "aet_trend", 
               "tmmn", "tmmn_resid", "tmmn_trend", "tmmx", "tmmx_resid", "tmmx_trend", "trend_long", "trend_short", "count_long", "count_short",
               lut$realms, lut$biomes)

data <- suppressWarnings(brick(c(ndvi, pr, aet, tmmn, tmmx, trend_long_assemblage, trend_short_assemblage, 
