# This adapted confint.mboost function was originally developed for my fireworks
# disturbance analysis. See original here: https://github.com/barthoekstra/fireworks
...
model <- readRDS("data/processed/models/mod_trends_rac.RDS")  # Change model to analyze
folds <- readRDS("data/processed/models/confints/folds.RDS")  # Change folds
...
for (i in 1:1000) {
  ...
  saveRDS(ci, file = paste0("data/processed/models/confints/modelci_trends_rac_", i, ".RDS"))  # Change filename pattern
  rm(ci)
}