...
model_formula <- function(predictors, response) {
...
formula_all <- model_formula(predictors_all, "trend_long")
...
```{r partial_effects_simple_original_all, out.width='100%', fig.width=10, fig.height=15}
par(mfrow = c(4, 3))
plot(mod_all)
```
...
plot(mod_resids_rac)
```
```{r partial_effects_simple_rac_all, out.width='100%', fig.width=10, fig.height=15}
par(mfrow = c(4, 3))
plot(mod_all_rac)
```
